  ...
  <div>
    ...
    <el-dialog :title="isEdit?'修改文章分类':'添加文章分类'" :visible.sync="addVisible" width="35%"  @closed="onAddClosedFn">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button size="mini" type="primary" @click="addFn">{{ isEdit?'修改':'添加' }}</el-button>
    </span>
    </el-dialog>
  </div>
...
export default {
  ...
  methods: {
    ...
    async initCateListFn () {
      ...
      // console.log(res)
      // this.cateList = [{ id: '123', cate_name: '平凡的世界', cate_alias: '路遥' }, { id: '124', cate_name: '海贼王', cate_alias: 'One Piece' }]
